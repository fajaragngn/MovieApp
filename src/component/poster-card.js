...
class PosterCards extends React.Component {
  ...
  render() {
    ...
    const date = this.state.dataTv.type
      ...
      : new Date(this.state.data.release_date);
        ...
        <div className="poster-header">
          <div className="poster-inner">
            {this.state.dataTv.type ? (
              ...
              <Link to={ID}>
                <img
                  src={`https://image.tmdb.org/t/p/w300/${this.state.data.poster_path}`}
                />
              </Link>
            )}
            <div className="poster-title">
              {this.state.dataTv.type ? (
                ...
                <>
                  ...
                  <h3>
                    <Link to={ID}>
                      {this.state.data.title} ({date.getFullYear()})
                    </Link>
                  </h3>
                  <Link to={ID}> Back</Link>
                </>
