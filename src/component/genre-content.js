...
class GenreContent extends React.Component {
  ...
  async componentDidMount() {
    const movieGenre = await fetch(
      `https://api.themoviedb.org/3/discover/movie?api_key=0ccbee0a69447c2b1bd0090bf76b0358&with_genres=${this.props.id}`
    );
    const tvGenre = await fetch(
      `https://api.themoviedb.org/3/discover/tv?api_key=0ccbee0a69447c2b1bd0090bf76b0358&with_genres=${this.props.id}`
    );
  ...
  async componentDidUpdate() {
    const pageResult = await fetch(
      `https://api.themoviedb.org/3/discover/movie?api_key=0ccbee0a69447c2b1bd0090bf76b0358&with_genres=${this.props.id}&page=${this.state.pages}`
    );
    const TvPage = await fetch(
      `https://api.themoviedb.org/3/discover/tv?api_key=0ccbee0a69447c2b1bd0090bf76b0358&with_genres=${this.props.id}&page=${this.state.pages}`
    );
